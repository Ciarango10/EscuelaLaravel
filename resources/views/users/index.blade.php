                ...
                <form class="navbar-search" method="GET" action="{{ route('users.index')}}" >
                    ...
                    <div class="row mt-3">
                        <div class="col-md-auto">
                            ...
                            <select class="form-select bg-light" value="{{ $data->records_per_page }}" name="records_per_page">
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('users.edit', $user->id) }}" class="btn btn-sm btn-warning"><i class="fa-solid fa-pencil"></i></a>
                                </td>
                            </tr>
