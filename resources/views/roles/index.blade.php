        ...
        <div class="card">
            <div class="card-header py-3">
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <a href="{{ route('roles.create') }}" class="btn btn-primary"><i class="fa fa-add"></i></a>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($roles as $role)
                            ...
                            <tr>
                                <td> {{ $role->name }} </td>
                                <td>
                                    <a href="{{ route('roles.edit', $role->id) }}" class="btn btn-sm btn-warning"><i class="fa-solid fa-pencil"></i></a>
